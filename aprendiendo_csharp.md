---
# Agenda para Wilfredo!
---
# Curso de C# por freecodecamp con microsoft:
## recursos:

https://www.freecodecamp.org/learn/foundational-c-sharp-with-microsoft/

---
# Aprendiendo C# con Microsoft y freecodecamp

1. La función WriteLine nos agrega un salto de línea al final del texto.
2. La función Write no agrega un salto de línea al final del texto.
3. Los comentarios en C# se hacen con // para comentarios de una sola línea y /* */ para comentarios de múltiples líneas.
4. Las comillas simples ('') se usan para caracteres individuales, mientras que las comillas dobles("") se usan para cadenas de texto.
